# -*- coding: utf-8 -*-
"""덕남 원수성상 슬라이딩 윈도우 군집화 실행 스크립트.

실행: python run_clustering.py   (01_clustering 디렉터리에서)
산출:
  dataset/clustering_data/덕남_군집라벨.parquet   (원본 44 + 피처 10 + cluster_label)
  dataset/clustering_data/덕남_cluster{0,1,2}.parquet
  output/model/덕남_kmeans_k3.joblib
